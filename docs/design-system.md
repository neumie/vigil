...
| Work hub group | "Work" group with Run details / Task / Plan nav rows | one source Task push row; Plan facts inline with a Plan documents push row |
